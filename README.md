...
-----------------------------
**2019 - 2021**
* <span color="blue">**Software Version Control**</span> (Web Application) | C# .Net MVC/Javascirpt/SQL Server
    <p> A version control solution for production tooling that eliminates deployment errors by ensuring all systems run on the correct, verified software version. </p>
* **External Packing Monitoring** (Web Application) | C# .Net MVC/Javascirpt/SQL Server
    <p> Monitor production line output to ensure daily export and delivery targets are met according to the scheduled plan. </p>
**2021 - 2023**
* **COVID-19 Risk Assessment** (Web Application) | Javascirpt/FireBase database/FireBase Hosting
  <p>A Web-based Bus Seating & Risk Monitoring System designed to identify and track individuals with COVID-19 risks. The application provides a real-time visual interface to monitor passenger placement, enabling rapid contact tracing and safety management within the production team.</p>
* **Request Migration Management** (Web Application) | C# .Net MVC/Javascirpt/SQL Server
    <p>An internal application designed for users to submit requests for product data modifications within the production database, ensuring data integrity and streamlined approval workflows. </p>
* **Engineering Change Control System** (Web Application) | C# .Net MVC/Javascirpt/SQL Server
  <p>A centralized platform to manage engineering changes such as product structure and warranty updates. It ensures all modifications are documented and traceable, making it easy for team members to follow up on the latest status</p>
